...
async function seed() {
    ...
    const sampleAdmins = [
        ...
        // --- NGO ---
        {
            ...
            faith: null,
          organizationSubtype: 'trust',
            phone: '9876543233',
            address: 'Delhi',
          panNumber: 'ABCDE1234F',
          registration80GNumber: '80G/DELHI/HELPAGE/0001',
        },
        {
            name: 'PETA India',
            email: 'peta@ngo.com',
            ...
            organizationCategory: ORGANIZATION_CATEGORIES.NGO,
            faith: null,
          organizationSubtype: 'society',
            phone: '9876543234',
            address: 'Mumbai, Maharashtra',
          panNumber: 'BCDEA2345G',
          registration80GNumber: '80G/MH/PETA/0002',
        },
        {
            ...
            organizationCategory: ORGANIZATION_CATEGORIES.NGO,
            faith: null,
          organizationSubtype: 'foundation',
            phone: '9876543235',
            address: 'Delhi',
          panNumber: 'CDEAB3456H',
          registration80GNumber: '80G/DELHI/SMILE/0003',
        },
        {
            name: 'Goonj',
            email: 'goonj@ngo.com',
          ...
          organizationSubtype: 'trust',
            phone: '9876543236',
            address: 'Delhi',
          panNumber: 'DEABC4567J',
          registration80GNumber: '80G/DELHI/GOONJ/0004',
        },
        {
          name: 'Shree Seva Trust (Dummy)',
          email: 'shreeseva@trust.com',
          password: 'Password123!',
          organizationCategory: ORGANIZATION_CATEGORIES.NGO,
          faith: null,
          organizationSubtype: 'trust',
          phone: '9876543237',
          address: 'Ahmedabad, Gujarat',
          panNumber: 'EABCD5678K',
          registration80GNumber: '80G/GJ/SHREESEVA/0005',
        },
        {
          name: 'Nayi Disha Trust (Dummy)',
          email: 'nayidisha@trust.com',
          password: 'Password123!',
          organizationCategory: ORGANIZATION_CATEGORIES.NGO,
          faith: null,
          organizationSubtype: 'trust',
          ...
          panNumber: 'FABCD6789L',
          registration80GNumber: '80G/RJ/NAYIDISHA/0006',
        },
    ];
        ...
        try {
            ...
            if (!existing) {
                ...
                await existing.update({
                    ...
                    panNumber: adminData.panNumber || existing.panNumber,
                    registration80GNumber: adminData.registration80GNumber || existing.registration80GNumber,
                });
